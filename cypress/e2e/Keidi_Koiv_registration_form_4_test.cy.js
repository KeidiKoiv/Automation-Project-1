...
describe('Input fields', () => {
    it('Username cannot be empty string', () => {
        ...
        //successful message should not be visile
    ...
    it('Username should have min and max length values 1 and 50 characters', () => {
        // check that username HTML has min attribute value equals to 1
        cy.get('#username').should('have.attr', 'min', '1')

        // check that username HTML has max attribute value equals to 50
